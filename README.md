...
Учебный фреймворк для автоматизированного тестирования мобильных приложений. Проект реализует подход к тестированию UI слоя. Есть возможность зауска на разных окружениях: browserstack servise или локально на эмуляторе.
